...
// checks if the ApplicationRepresentation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationRepresentation{}

// ApplicationRepresentation struct for ApplicationRepresentation
...
func (o ApplicationRepresentation) MarshalJSON() ([]byte, error) {
...
func (o ApplicationRepresentation) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationRepresentation struct {
	value *ApplicationRepresentation
	isSet bool
}

func (v NullableApplicationRepresentation) Get() *ApplicationRepresentation {
	return v.value
}

func (v *NullableApplicationRepresentation) Set(val *ApplicationRepresentation) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationRepresentation) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationRepresentation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationRepresentation(val *ApplicationRepresentation) *NullableApplicationRepresentation {
	return &NullableApplicationRepresentation{value: val, isSet: true}
}

func (v NullableApplicationRepresentation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationRepresentation) UnmarshalJSON(src []byte) error {
	v.isSet = true
